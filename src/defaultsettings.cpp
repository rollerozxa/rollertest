...
void set_default_settings()
{
	...
	settings->setDefault("font_path_italic", porting::getDataPath("fonts" DIR_DELIM "Archivo-Italic.ttf"));
	settings->setDefault("font_path_bold", porting::getDataPath("fonts" DIR_DELIM "Archivo-Bold.ttf"));
	settings->setDefault("font_path_bold_italic", porting::getDataPath("fonts" DIR_DELIM "Archivo-BoldItalic.ttf"));
	...
	settings->setDefault("fallback_font_path", porting::getDataPath("fonts" DIR_DELIM "DroidSansFallback-Full.ttf"));
