...
void TouchScreenGUI::init(ISimpleTextureSource *tsrc)
{
	...
	// init jump button
	initButton(jump_id,
			rect<s32>(m_screensize.X - 3.4f * button_size,
					m_screensize.Y - 3 * button_size,
					m_screensize.X - 1.9f * button_size,
	...
	initButton(chat_id,
			rect<s32>(m_screensize.X - 1.25f * button_size,
					0.25f * button_size,
					m_screensize.X - 0.25f * button_size,
					button_size + 0.25f * button_size),
			L"chat", true);

	initButton(inventory_id,
			rect<s32>(m_screensize.X/5.5f,
					m_screensize.Y - button_size,
					m_screensize.X/5.5f + button_size,
					m_screensize.Y),
			L"inv", true);

	initButton(drop_id,
			rect<s32>(0.25 * button_size,
					m_screensize.Y - 4.75f * button_size,
					button_size + 0.25f * button_size,
					m_screensize.Y - 3.75f * button_size),
    		L"inv", true);
